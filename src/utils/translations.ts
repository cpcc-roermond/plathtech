  ...
  ar: {
    ...
    aboutMe: {
      ...
      whyDifferent: {
        ...
        subtitle: 'حين تلتقي الخبرة الاستشارية بمختبر الذكاء الاصطناعي',
        synergy: {
        ...
        conclusion: 'نبسّط التعقيد ونعزّز القيمة - بقوة كلا العالمين.'
      },
      experience: {
      ...
      projects: {
        ...
        hardwareRollout: {
          ...
          items: [
            ...
            'استبدال الأجهزة القديمة بعملاء افتراضيين في مواقع متعددة'
          ]
        },
        processDesign: {
